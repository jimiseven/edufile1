...
<head>
    ...
    <title>EduFile - Cursos de Primaria</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="d-flex">
        ...
        <div class="main-content">
            <h2 class="mb-4">Nivel Primaria - Cursos</h2>
            ...
            <div class="accordion" id="accordionGrados">
                ...
                $query = "SELECT id, grade, parallel FROM courses WHERE level_id = 2 ORDER BY grade, parallel";
                ...
                foreach ($coursesByGrade as $grade => $courses) {
                    ...
                    foreach ($courses as $course) {
                        ...
                        echo '<a href="vistaGenCurso.php?grade=' . urlencode($grade) . '&parallel=' . urlencode($parallel) . '&level=Primario" class="btn btn-view btn-sm">Ver <i class="bi bi-eye"></i></a>';
                        echo '</div>';
                        echo '</div>';
                    }
